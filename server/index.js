...
db.query(
  "CREATE TABLE playlists (id INT NOT NULL AUTO_INCREMENT,title VARCHAR(45) NOT NULL,song VARCHAR(45) NOT NULL,username VARCHAR(45) NOT NULL,email VARCHAR(45) NOT NULL,ispublic BOOLEAN NOT NULL,description VARCHAR(2000),createdAt DATETIME NOT NULL DEFAULT GETDATE,updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (id));",
  (req, res) => {}
);
