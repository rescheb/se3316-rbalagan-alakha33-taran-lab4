...
db.query(
  "CREATE TABLE playlists (id INT NOT NULL AUTO_INCREMENT,title VARCHAR(45) NOT NULL,song VARCHAR(45) NOT NULL,username VARCHAR(45) NOT NULL,email VARCHAR(45) NOT NULL,ispublic BOOLEAN NOT NULL,description VARCHAR(2000),createdAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,updatedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (id));",
  (req, res) => {}
);
...
db.query(
  "CREATE TABLE currentuser(username VARCHAR(200), time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)",
  (req, res) => {}
);

db.query(
  "CREATE TABLE reviews(playlist_title VARCHAR(200),cusername VARCHAR(50),username VARCHAR(200),review VARCHAR(1000),rating INT, date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)",
  (req, res) => {}
);

db.query(
  "CREATE TABLE dmca(value VARCHAR(5000), updated_At TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)",
  (req, res) => {}
);
