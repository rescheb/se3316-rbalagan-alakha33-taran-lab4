...
export default function PrivatePlaylist() {
  ...
  const createPlaylist2 = async () => {
    await fetch(
      "http://localhost:9000/playlist/playlistNum?name=" + currentUser.email,
      {
        method: "GET",
        headers: new Headers({ "Content-Type": "application/json" }),
      }
    ...
    await fetch(
      "http://localhost:9000/playlist/playlistNames?name=" + currentUser.email,
      {
        method: "GET",
        headers: new Headers({ "Content-Type": "application/json" }),
      }
  ...
  const createPlaylist = async () => {
    createPlaylist2();
    let songs5 = song.split(",");
    let value3 = true;
    for (let f = 0; f < songs5.length; f++) {
      if (!track_ids.includes(songs5[f])) {
        value3 = false;
        break;
      }
    }
        ...
        if ((await playlistCount[0].num) < 20) {
          if (playlistTitles.filter((y) => y.title === title).length == 0) {
            ...
            if (title != "" && song != "") {
              ...
              fetch(
                "http://localhost:9000/playlist/emailusername?name1=" +
                  currentUser.email,
                {
                  method: "GET",
                  headers: new Headers({ "Content-Type": "application/json" }),
                ...
                .then((data2) => {
                  ...
                  fetch(
                    ...
                    .then((data) => {
                      console.log(
                        playlistTitles.filter((y) => y.title === title).length
                      );
                    })
  ...
  const playlistDescription = async () => {
    fetch(
      "http://" +
        window.location.hostname +
        ":9000/playlist/playlistDescription",
      {
        method: "POST",
        body: JSON.stringify({
  ...
  const addreview = async () => {
    fetch(
      "http://localhost:9000/playlist/emailusername?name1=" + currentUser.email,
      {
        method: "GET",
        headers: new Headers({ "Content-Type": "application/json" }),
      }
      ...
      .then((data2) => {
        ...
        console.log(JSON.stringify(data2));
        fetch(
          "http://" + window.location.hostname + ":9000/playlist/addreview",
          {
            method: "POST",
            body: JSON.stringify({
              title: title5,
  ...
  const deletePlaylist = async () => {
    ...
    if (u == 2) {
      fetch(
        "http://" + window.location.hostname + ":9000/playlist/deletePlaylist",
        {
          method: "POST",
          body: JSON.stringify({ title: title3, email: currentUser.email }),
          headers: new Headers({ "Content-Type": "application/json" }),
        }
      )
        .then((res) => res.json())
  ...
  return (
    <div className="privateSearch">
      ...
      <div className="createPlaylist">
        ...
        ispublic
        <br></br>
        <button onClick={test2} className="cpbtn">
          Create Playlist
        </button>
      </div>
      ...
      <div className="delete">
        <input
          type="text"
          placeholder="Playlist Name to Delete"
          required
          value={title3}
          onChange={(e) => setTitle3(e.target.value)}
        />
        <br></br>
        <button onClick={deletePlaylist} className="ebtn">
          Delete Playlist
        </button>
        <button onClick={deletePlaylist} className="ebtn">
          Confirm Delete Playlist
        </button>
        <button onClick={cancelDeletePlaylist} className="ebtn">
          {" "}
      ...
      <div className="description">
        <input
          type="text"
          placeholder="Enter Playlist to Add desc"
          required
          value={title4}
        ...
        />
        <button onClick={playlistDescription} className="ebtn">
          Add Description
        </button>
      </div>
      ...
      <div className="reviews">
        ...
        <input
          type="text"
          placeholder="Enter Playlist to Add Review"
          required
          value={title5}
        ...
        />
        <button onClick={addreview} className="ebtn">
          Add Review
        </button>
      </div>
